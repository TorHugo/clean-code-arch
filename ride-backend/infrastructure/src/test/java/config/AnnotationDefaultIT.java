...
public class AnnotationDefaultIT {
    public final static String expectedMessageToEqual = "Given values, both must be equal.";
    public final static String expectedMessageNonNull = "This value, is not null.";
